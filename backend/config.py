...
LLM_MODEL_DIR = os.environ.get("LLM_DIR") or os.environ.get("LLM_MODEL_ROOT") or os.path.join(ROOT, "models", "llm")
LTX_MODEL_DIR = os.environ.get("LTX_MODEL_ROOT") or os.path.join(ROOT, "models", "ltx")
